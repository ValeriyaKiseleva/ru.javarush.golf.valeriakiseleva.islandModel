package MyIslandModel.IslandReferences;

import MyIslandModel.IslandFauna.Animal.Herbivore.*;
import MyIslandModel.IslandFauna.Animal.Predator.*;

import java.util.*;

public class AnimalRationReference {
